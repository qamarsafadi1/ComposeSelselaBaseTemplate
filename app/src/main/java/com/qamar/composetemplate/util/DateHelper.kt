...
class DateHelper {
    companion object {
        ...
        fun getTodayFormatedDate(): String {
            val ddd = SimpleDateFormat("yyyy-MM-dd . hh:mm a", Locale.ENGLISH)
            try {
        ...
        fun getAmPm(createdAt: String): String {
            val h_mm_a = SimpleDateFormat("HH:mm:ss", Locale.ENGLISH)
        ...
        fun getAmPmCratedAt(createdAt: String): String {
            val h_mm_a = SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSSSS'Z'", Locale.ENGLISH)
            val hh_mm = SimpleDateFormat("dd/MM/yyyy . hh:mm a", Locale.ENGLISH)
            try {
                val d1 = h_mm_a.parse(createdAt)
                d1?.let {
                    return hh_mm.format(d1)
